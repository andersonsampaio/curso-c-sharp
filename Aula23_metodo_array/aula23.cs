...
class Aula23_metodo_array{
    static void Main(){
        ...
        //retorno -1 significa que não existe o valor no vetor
        ...
        //plubic void CopyTo(Ar_destino,a_partir_desta_pos);
        ...
        Console.WriteLine("Qtd de elementos {0}",qtdeElementosVetor);
        Console.WriteLine("----------------------------------------------");
        ...
        Console.WriteLine("Menor Índice do vetor1 {0}",MenorIndiceMatriz_D1);
        Console.WriteLine("----------------------------------------------");
        ...
        //retorna o primeiro valor espcificado encontrado
